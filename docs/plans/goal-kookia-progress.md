...
Q1, Q1b, C1, D1 et D2 sont prouvés localement sur des fixtures synthétiques. Le
contrôle rendu/clavier de C1/Q2 reste en attente d'un navigateur accessible ;
continuer D3–D6 selon leurs dépendances avant d'ouvrir C2. Ne pas activer d'OCR
ou d'envoi fournisseur dans ces parcours de démonstration.
