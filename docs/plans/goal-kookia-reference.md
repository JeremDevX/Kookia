...
| 2025 — ajustements de carte | Une version de recette change à date effective ; anciennes productions gardent l'ancienne version. Un avoir, une ligne ambiguë et une variation de prix déclenchent revue, non crédit automatique. Le scénario injecte explicitement un surstock, une perte et un **stock insuffisant bloquant** (jamais artificiellement négatif) pour éprouver le chemin de correction. | Épisodes de surstock, rupture, perte, ventes et composition sont simulés sauf preuve source explicite. |
| 2026 — service et achat à venir | Camille complète le dernier service, vérifie stock et factures à traiter, consulte une estimation seulement si les jours sont couverts, revoit une quantité et valide une commande « à transmettre » ; la réception future reste distincte. Montrer aussi source en panne, service partiel et stock périmé. | 186 pièces datées seulement jusqu'en septembre ; les 28 jours de baseline et l'impact économique ne sont pas une performance terrain. |
