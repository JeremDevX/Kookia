...
export default function SalesMetrics({ from, to }: Props) {
  ...
  return <section className="sales-panel sales-metrics" aria-labelledby="sales-metrics-title">
    ...
    <p>Source : saisies manuelles, imports CSV, lignes de caisse confirmées ou simulation du restaurant. {sourceDescription} Une ligne absente ne vaut zéro que si le calendrier du jour est complet ; les jours partiels, manquants ou non renseignés restent inconnus.</p>
