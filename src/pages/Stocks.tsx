...
const Stocks: React.FC = () => {
  ...
  return (
    <div className="stocks-container workspace-page">
      ...
      <p className="stocks-source">Quantités enregistrées dans ce restaurant. Le catalogue initial contient des exemples à confirmer ; les entrées issues des factures et les sorties associées sont des simulations à vérifier sur les originaux. Les seuils ne tiennent pas compte des ventes importées.</p>
